...
## Project Structure
    ...
    ├── testapiautocatalog_116252  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116252`
...
2. Clone this repo and `cd testapiautocatalog_116252`
